...
{
    mcode_t opcode = CONST_CAST(minsn_t*)(&insn)->opcode;
    if (opcode == mcode_t::m_jnz || 
        opcode == mcode_t::m_jz || 
        opcode == mcode_t::m_ja || 
        opcode == mcode_t::m_jae || 
        opcode == mcode_t::m_jb || 
        opcode == mcode_t::m_jbe || 
        opcode == mcode_t::m_jcnd || 
        opcode == mcode_t::m_jg || 
        opcode == mcode_t::m_jge || 
        opcode == mcode_t::m_jl || 
        opcode == mcode_t::m_jle)
        return 0;
